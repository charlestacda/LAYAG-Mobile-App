          ...
          child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Column(
                ...
                children: [
                  RichText(
                    text: const TextSpan(style: TextStyle(fontSize: 15, color: Colors.black), children: [
                      TextSpan(
                          text: 'The LPU-C mobile application is designed to provide digital services for the entire '
                  ...
                  RichText(
                    text: const TextSpan(style: TextStyle(fontSize: 25, color: Colors.black, fontWeight: FontWeight.bold), children: [
                    ...
                    text: const TextSpan(style: TextStyle(fontSize: 15, color: Colors.black), children: [
                      TextSpan(
                          text: 'In the To-Do-List section, the user can add a task by tapping the button. '
                              ...
                              'of a particular task is greater than two days, the app will set the color oof the task to green. '
                              'If the due date is equals to one or two days, the task color will be set to yellow. Lastly, '
                              'if the task is due, the color of the task wll be set to red. If the task is marked completed, '
                              'the system will remove the task in the list then display it under the task completed list.'),
                    ]),
                    softWrap: true,
                    textAlign: TextAlign.justify,
                  ),
                  ...
                  SizedBox(
                    ...
                    child: Row(children: [
                      RichText(
                        text: const TextSpan(style: TextStyle(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold), children: [
                      ...
                      TextButton(
                        child: const Text(
                          'click here',
                          style: TextStyle(fontSize: 15, color: AppConfig.appSecondaryTheme, fontWeight: FontWeight.bold),
                        ),
                        onPressed: () {
                          URL.launch('https://drive.google.com/file/d/1mTH-5GG_Zf8QohVUrwwOROdHiArxTmZz/view?usp=sharing');
                        },
                      ),
                      const SizedBox(height: 20),
                      RichText(
