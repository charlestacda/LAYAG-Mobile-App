                      ...
                      Center(
                        child: Column(
                          children: [
                            ...
                            SizedBox(
                                height:
                                    10), // Adjust the height to create the desired space
                            const Text(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                focusedBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                    color: Color(
                                        0xFFA33334), // Border color when focused
                                    width:
                                        2.0, // Change the width of the border when focused
                                  ),
                                ),
                                contentPadding:
                                ...
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    contentPadding: EdgeInsets.only(
                                        left: 16,
                                        right:
                                            48), // Adjust right padding for the icon
                                    prefixIcon: Icon(
                                      Icons.lock,
                                      color: Color(0xffA62D38),
                                    ),
